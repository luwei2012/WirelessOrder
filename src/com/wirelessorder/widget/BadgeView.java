...
public class BadgeView extends TextView {
	...
	private void applyTo(View target) {
		...
		if (target instanceof TabWidget) {
			...
			container.setPadding(0, -4, 35, 0);
			LinearLayout.LayoutParams containerLayout = new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT) ;
//			containerLayout.setMargins(0, 20, 0, 0);
			((ViewGroup) target).addView(container, containerLayout);
...
//			Log.d("parent is ",parent.getClass().isInstance(ViewGroup.class)+"");
